...
extern const u8 gText_MenuSuperTutor[];
extern const u8 gText_MenuRemoteMart[];
extern const u8 gText_MenuRemoteHeal[];
extern const u8 gText_MenuRemotePC[];
extern const u8 gText_MenuRemoteBikeSwap[];
...
extern const u8 gText_SuperTutor[];
extern const u8 gText_RemoteMart[];
extern const u8 gText_RemoteHeal[];
extern const u8 gText_RemotePC[];
extern const u8 gText_RemoteBikeSwap[];
