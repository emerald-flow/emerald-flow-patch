...
extern const u8 gText_LevelCapOn_CLASSIC_LEVELCAP[];
extern const u8 gText_LevelCapOff_CLASSIC_LEVELCAP[];
extern const u8 gText_ForgetHMsOn_CLASSIC_FORGETHMS[];
extern const u8 gText_ForgetHMsOff_CLASSIC_FORGETHMS[];
extern const u8 gText_InfiniteTMsOn_CLASSIC_INFINITETMS[];
extern const u8 gText_InfiniteTMsOff_CLASSIC_INFINITETMS[];
extern const u8 gText_PermaRepelOn_CLASSIC_PERMAREPEL[];
extern const u8 gText_PermaRepelOff_CLASSIC_PERMAREPEL[];
extern const u8 gText_1CostItemsOn_CLASSIC_1COSTITEMS[];
extern const u8 gText_1CostItemsOff_CLASSIC_1COSTITEMS[];
extern const u8 gText_EVTrainingOff_CLASSIC_EVTRAINING[];
extern const u8 gText_EVTrainingVanilla_CLASSIC_EVTRAINING[];
extern const u8 gText_EVTrainingEasy_CLASSIC_EVTRAINING[];
...
extern const u8 gText_LevelCap_CLASSIC_LEVELCAP[];
extern const u8 gText_ForgetHMs_CLASSIC_FORGETHMS[];
extern const u8 gText_InfiniteTMs_CLASSIC_INFINITETMS[];
extern const u8 gText_PermaRepel_CLASSIC_PERMAREPEL[];
extern const u8 gText_1CostItems_CLASSIC_1COSTITEMS[];
extern const u8 gText_EVTraining_CLASSIC_EVTRAINING[];
