...
extern const u8 gText_MenuPocketTutor[];
extern const u8 gText_MenuPocketMart[];
extern const u8 gText_MenuPocketHeal[];
extern const u8 gText_MenuPocketPC[];
extern const u8 gText_MenuPocketBikes[];
extern const u8 gText_MenuMoveUtils[];
...
// option menu texts
extern const u8 gText_Slow[];
extern const u8 gText_Mid[];
...
extern const u8 gText_Stereo[];
extern const u8 gText_FrameTypeNumber[];
extern const u8 gText_FrameType[];
extern const u8 gText_LR[];
extern const u8 gText_LEqualsA[];
extern const u8 gText_Lvl30[];
extern const u8 gText_Item[];
extern const u8 gText_Indoor[];
extern const u8 gText_Perma[];
...
extern const u8 gText_InfiniteTm[];
extern const u8 gText_PermaRepel[];
extern const u8 gText_OneDollarItems[];
...
extern const u8 gText_HundredP[];
...
extern const u8 gText_YouWantAdopt[];
extern const u8 gText_AreYouSureThisIsTheSpecies[];
extern const u8 gText_WhoseEggYouWantToAdopt[];
extern const u8 gText_PSS[];
extern const u8 gText_Physical[];
extern const u8 gText_Special[];
extern const u8 gText_Status2[];
extern const u8 gText_BadgeBoost[];
extern const u8 gText_FastEggs[];
extern const u8 gText_OneX[];
extern const u8 gText_FourX[];
extern const u8 gText_TenX[];
extern const u8 gText_BetterSummary[];
extern const u8 gText_PocketTutor[];
extern const u8 gText_PocketMart[];
extern const u8 gText_PocketHeal[];
extern const u8 gText_PocketPC[];
extern const u8 gText_PocketBikes[];
extern const u8 gText_MoveUtils[];
...
extern const u8 gText_MoveUtilsDig[];
extern const u8 gText_MoveUtilsFlash[];
extern const u8 gText_MoveUtilsFly[];
extern const u8 gText_MoveUtilsSweetScent[];
extern const u8 gText_MoveUtilsTeleport[];
...
extern const u8 gEasyChatGroupName_Pokemon_Kanto[];
extern const u8 gEasyChatGroupName_Pokemon_Johto[];
extern const u8 gEasyChatGroupName_Pokemon_Hoenn[];
