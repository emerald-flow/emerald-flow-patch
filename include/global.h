...
struct SaveBlock2
{
    ...
    /*0x90*/ u8 filler_90;
    /*0x91*/ u8 optionsEvTraining:2;
             u8 optionsBetterEvos:2;
             u8 optionsRunning:2;
             u8 optionsLevelCap:1;
             u8 optionsForgetHm:1;
    /*0x92*/ u8 optionsInfiniteTm:1;
             u8 optionsPermaRepel:1;
             u8 optionsOneDollarItems:1; 
...
struct SaveBlock1
{
    ...
    /*0x3598*/ u16 adoptionSpecies[1]; // Oh god. u16 and even addresses
               u8 unused_359B[0x17E];
