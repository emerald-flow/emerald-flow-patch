...
#define OPTIONS_EVTRAINING_OFF 0
#define OPTIONS_EVTRAINING_NORMAL 1
#define OPTIONS_EVTRAINING_EASY 2

#define OPTIONS_FASTEGGS_1X 0
#define OPTIONS_FASTEGGS_4X 1
#define OPTIONS_FASTEGGS_10X 2
...
#define OPTIONS_BETTEREVOS_OFF 0
#define OPTIONS_BETTEREVOS_LVL30 1
#define OPTIONS_BETTEREVOS_ITEM 2

#define OPTIONS_RUNNING_OFF 0
#define OPTIONS_RUNNING_INDOORS 1
#define OPTIONS_RUNNING_ALWAYS 2

#define OPTIONS_POKENAVCALL_NORMAL 0
#define OPTIONS_POKENAVCALL_NOTIFY 1
#define OPTIONS_POKENAVCALL_SILENT 2

#define BETTEREVOS_LVL30 30
