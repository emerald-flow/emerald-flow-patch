...
#define OPTIONS_EVTRAINING_OFF_CLASSIC_EVTRAINING 0
#define OPTIONS_EVTRAINING_VANILLA_CLASSIC_EVTRAINING 1
#define OPTIONS_EVTRAINING_EASY_CLASSIC_EVTRAINING 2
