...
const u8 gText_SuperTutor[] = _("SUPER TUTOR");
const u8 gText_RemoteMart[] = _("REMOTE MART");
const u8 gText_RemoteHeal[] = _("REMOTE HEAL");
const u8 gText_RemotePC[] = _("REMOTE PC");
const u8 gText_RemoteBikeSwap[] = _("BIKE SWAP");
