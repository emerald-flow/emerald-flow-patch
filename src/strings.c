...
const u8 gText_LevelCap_CLASSIC_LEVELCAPS[] = _("LEVEL CAP");
const u8 gText_BetterTMHM_CLASSIC_BETTERTMHM[] = _("BETTER TMs/HMs");
...
const u8 gText_LevelCapOn_CLASSIC_LEVELCAPS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_LevelCapOff_CLASSIC_LEVELCAPS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_BetterTMHMOn_CLASSIC_BETTERTMHM[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BetterTMHMOff_CLASSIC_BETTERTMHM[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
