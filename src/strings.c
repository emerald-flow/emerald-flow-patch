...
const u8 gText_Normal2[] = _("NORMAL");
...
const u8 gText_MoveUtilsDig[] = _("DIG");
const u8 gText_MoveUtilsFlash[] = _("FLASH");
const u8 gText_MoveUtilsFly[] = _("FLY");
const u8 gText_MoveUtilsSweetScent[] = _("SWEET SCENT");
const u8 gText_MoveUtilsTeleport[] = _("TELEPORT");
...
const u8 gText_ForgetHm[] = _("FORGET HMs");
const u8 gText_InfiniteTm[] = _("INFINITE TMs");
const u8 gText_PermaRepel[] = _("PERMANENT REPEL");
const u8 gText_OneDollarItems[] = _("ONE ¥ ITEMS");
const u8 gText_EvTraining[] = _("EV TRAINING");
const u8 gText_BetterSafari[] = _("BETTER SAFARI");
const u8 gText_CatchRate[] = _("PERFECT CATCHES");
const u8 gText_NoFleeingMon[] = _("NO FLEEING MON");
const u8 gText_NoHMSlave[] = _("NO HM SLAVE");
const u8 gText_AlwaysFeebas[] = _("ALWAYS FEEBAS");
const u8 gText_AutoBlend[] = _("AUTO BLEND");
const u8 gText_InstaFish[] = _("INSTANT FISHING");
const u8 gText_InstaText[] = _("INSTANT TEXT");
const u8 gText_PokenavCall[] = _("POKENAV CALL");
...
const u8 gText_Status2[] = _("Status");
const u8 gText_BetterSummary[] = _("BETTER SUMMARY");
const u8 gText_FastEggs[] = _("FAST EGGS");
const u8 gText_PocketTutor[] = _("POCKET TUTOR");
const u8 gText_PocketMart[] = _("POCKET MART");
const u8 gText_PocketHeal[] = _("POCKET HEAL");
const u8 gText_PocketPC[] = _("POCKET PC");
const u8 gText_PocketBikes[] = _("POCKET BIKES");
const u8 gText_CustomBlend[] = _("CUSTOM BLEND");
const u8 gText_BetterEvos[] = _("BETTER EVOs");
const u8 gText_Running[] = _("RUNNING");
...
const u8 gText_Slow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SLOW");
const u8 gText_Mid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MID");
const u8 gText_Fast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FAST");
const u8 gText_On[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_Off[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_Normal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_Notify[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NOTIFY");
const u8 gText_Silent[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SILENT");
const u8 gText_Vitamin[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VITAMIN");
const u8 gText_Shift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SHIFT");
const u8 gText_Set[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SET");
const u8 gText_Mono[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MONO");
const u8 gText_Stereo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}STEREO");
...
const u8 gText_LR[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}LR");
const u8 gText_LEqualsA[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}L=A");
const u8 gText_Lvl30[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}LVL.30");
const u8 gText_Item[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ITEM");
const u8 gText_Indoor[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INDOOR");
const u8 gText_Perma[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}PERMA");
const u8 gText_OneX[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_FourX[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
const u8 gText_TenX[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}10x");
...
const u8 gText_MenuPocketTutor[] = _("TUTOR");
const u8 gText_MenuPocketMart[] = _("MART");
const u8 gText_MenuPocketHeal[] = _("HEAL");
const u8 gText_MenuPocketPC[] = _("PC");
const u8 gText_MenuPocketBikes[] = _("BIKES");
const u8 gText_MenuMoveUtils[] = _("MOVES");
