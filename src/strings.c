...
const u8 gText_BattleClause_CLASSIC_BATTLECLAUSE[] = _("BATTLE CLAUSE");
...
const u8 gText_BattleClauseOn_CLASSIC_BATTLECLAUSE[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BattleClauseOff_CLASSIC_BATTLECLAUSE[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
