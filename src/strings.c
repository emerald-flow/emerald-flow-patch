...
const u8 gText_LevelCap_CLASSIC_LEVELCAP[] = _("LEVEL CAP");
const u8 gText_ForgetHMs_CLASSIC_FORGETHMS[] = _("FORGET HMs");
const u8 gText_InfiniteTMs_CLASSIC_INFINITETMS[] = _("INFINITE TMs");
const u8 gText_PermaRepel_CLASSIC_PERMAREPEL[] = _("PERMA REPEL");
const u8 gText_1CostItems_CLASSIC_1COSTITEMS[] = _("1 COST ITEMS");
const u8 gText_EVTraining_CLASSIC_EVTRAINING[] = _("EV TRAINING");
...
const u8 gText_LevelCapOn_CLASSIC_LEVELCAP[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_LevelCapOff_CLASSIC_LEVELCAP[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_ForgetHMsOn_CLASSIC_FORGETHMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_ForgetHMsOff_CLASSIC_FORGETHMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_InfiniteTMsOn_CLASSIC_INFINITETMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_InfiniteTMsOff_CLASSIC_INFINITETMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_PermaRepelOn_CLASSIC_PERMAREPEL[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_PermaRepelOff_CLASSIC_PERMAREPEL[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_1CostItemsOn_CLASSIC_1COSTITEMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_1CostItemsOff_CLASSIC_1COSTITEMS[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_EVTrainingOff_CLASSIC_EVTRAINING[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_EVTrainingVanilla_CLASSIC_EVTRAINING[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VANILLA");
const u8 gText_EVTrainingEasy_CLASSIC_EVTRAINING[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}EASY");
